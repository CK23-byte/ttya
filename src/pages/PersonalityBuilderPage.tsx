            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl p-6 space-y-4">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-bold text-green-900">Hoe exporteer je een WhatsApp chat?</h3>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-3 items-start bg-white rounded-lg p-3 border border-green-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">Ga naar de chat met de persoon van wie je een profiel wilt maken</p>
                    </div>
                  ...
                  <div className="flex gap-3 items-start bg-white rounded-lg p-3 border border-green-200">
                    ...
                    <div className="flex-1">
                      <p className="font-semibold text-gray-900 mb-1">Tik op de naam</p>
                      <p className="text-sm text-gray-600">Bovenaan het scherm, tik op de naam of groepsnaam</p>
                    </div>
                    <div className="text-2xl">👆</div>
                  </div>
                  ...
                  <div className="flex gap-3 items-start bg-white rounded-lg p-3 border border-green-200">
                    ...
                    <div className="flex-1">
                      <p className="font-semibold text-gray-900 mb-1">Scroll naar beneden</p>
                      <p className="text-sm text-gray-600">Zoek en tik op <span className="font-mono bg-green-100 px-2 py-0.5 rounded">"Chat exporteren"</span> of <span className="font-mono bg-green-100 px-2 py-0.5 rounded">"Export chat"</span></p>
                    </div>
                    <div className="text-2xl">📤</div>
                  </div>
                  ...
                  <div className="flex gap-3 items-start bg-white rounded-lg p-3 border border-green-200">
                    ...
                    <div className="flex-1">
                      <p className="font-semibold text-gray-900 mb-1">Kies "Zonder media"</p>
                      <p className="text-sm text-gray-600">Selecteer <span className="font-semibold">"Zonder media"</span> voor een snellere upload (foto's en video's niet nodig)</p>
                    </div>
                    <div className="text-2xl">🚫📷</div>
                  </div>
                  ...
                  <div className="flex gap-3 items-start bg-white rounded-lg p-3 border border-green-200">
                    ...
                    <div className="flex-1">
                      <p className="font-semibold text-gray-900 mb-1">Bewaar het bestand</p>
                      <p className="text-sm text-gray-600">Het .txt bestand wordt opgeslagen in je Downloads map of je kunt het direct delen</p>
                    </div>
                    <div className="text-2xl">💾</div>
                  </div>
                  ...
                  <div className="flex gap-3 items-start bg-white rounded-lg p-3 border border-green-200">
                    ...
                    <div className="flex-1">
                      <p className="font-semibold text-gray-900 mb-1">Upload hier</p>
                      <p className="text-sm text-gray-600">Klik hierboven op het upload veld en selecteer het .txt bestand</p>
                    </div>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 mt-4">
                  <p className="text-xs text-amber-800">
                    <span className="font-semibold">💡 Tip:</span> Het bestand heet meestal iets als <span className="font-mono bg-amber-100 px-1 rounded">"WhatsApp Chat met [Naam].txt"</span>
                  </p>
                </div>
              </div>
            </div>
